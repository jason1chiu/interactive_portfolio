...
const typeDefs = gql`
  ...
  type Mutation {
    ...
    addAbout(information: String!, background: String!, education: String!, interests: String!): About
    updateAbout(information: String!, background: String!, education: String!, interests: String!): About
